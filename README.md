...
HC Aqueduct - a super casual RTS

## External Sprite Assets

The project uses pipoya sprite assets which are not included in this repository.

If cloning fresh:

1. Download pipoya assets from the official source.
2. `PIPOYA FREE RPG Character Sprites 32x32.zip`
2. Place them under:
   assets/characters/pipoya/

These files are gitignored to keep the repository size manageable.
